      ...
      <li>
        ...
        >
          <i className="fa fa-square" aria-hidden="true"></i>
                                            ...
                                            <div className="bar5 bar-c">
                                                <ul>
                                                    ...
                                                    <li className="ftsz-70p ml-10">
                                                        <button onClick={decreaseFontSize} className="dash_link_nt">
                                                            A<sup className="topbar-sup-txt">-</sup>
                                                        </button>
                                                    </li>
                                                    <li className="ftsz-90p">
                                                        <button className="dash_link_nt"  onClick={resetFontSize}>
                                                            A
                                                        </button>
                                                    </li>
                                                    <li className="ftsz-110p">
                                                        <button  onClick={increaseFontSize}  className="dash_link_nt">
                                                            A<sup className="topbar-sup-txt">+</sup>
                                                        </button>
                                                    </li>
                                            ...
                                            <div class="bar6 bar-c">
                                            <div>
        { storedUserString?  <button  onClick={handleLogout}><Link to='/'>logout</Link></button>:  
                                        ...
                                        <div class="head-logo">
                                            <h2 class="logo">
                                                <a href="/" title="Home" rel="home" class="header__logo" id="logo">
                                                    <img class="national_emblem" src={Logo} alt="national emblem" />
        ...
        >
          <i className="fa fa-square" aria-hidden="true"></i>
                                            ...
                                            <div class="bar6 bar-c">
                                                ...
                                                <div class="bar6 bar-c">
                                                <div>
        { storedUserString?   <button><Link to='/'>Logout</Link></button>:  
         <button><Link to='/candidate/login'>Login</Link></button>}
      </div>
                                            {/* <button><Link to='/candidate/login'>Login</Link></button> */}
